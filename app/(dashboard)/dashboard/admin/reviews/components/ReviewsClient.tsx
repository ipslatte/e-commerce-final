...
const statusColors = {
  ...
  approved: "bg-[#050b2c]/10 text-[#050b2c]",
  rejected: "bg-[#c90b0b]/10 text-[#c90b0b]",
};
    ...
    return (
      ...
      >
        <div className="p-4 bg-white rounded-full shadow-lg mb-4">
          <MessageSquare className="h-8 w-8 text-[#050b2c]" />
        </div>
        <h3 className="text-xl font-semibold text-[#050b2c]">No reviews yet</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-[#050b2c]/60">Total Reviews</p>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-[#050b2c]/60">Pending Reviews</p>
                <p className="text-2xl font-bold text-[#050b2c]">
                  {stats.pending}
                </p>
              </div>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleStatusChange(review._id, value)
                        }
                      >
                        <SelectTrigger
                          className={`w-[140px] ${
